  ...
  var renderer = {
    ...
    renderRects: function () {
      ...
      for(i = 0; i < rectsToRender.length; i += 1){
        ...
        if(rect.color){
          context.fillStyle = typeof rect.color == "string" ? rect.color : toRgbExpression(rect.color);
        }
    ...
    render: function(objects) {
      ...
      var ctx = this.canvasNode.getContext("2d"), // projector.projectScene(scene, camera)? 
          obj = null;
