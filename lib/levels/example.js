  ...
  lang.mixin(level, {
    ...
    enter: function(){
      ...
      var exampleSprite = new Sprite({
        name: 'example-sprite',
        state: (function(){
          var commonState = { img: images.shift(), offsetx: 0, offsety: 0, width: 50, height: 50, frames: 1, interval: 1000/60 };
          return {
      ...
      this.someEntity = new Entity({
        components: ["bouncing-movement", "example-sprite"],
        bounds: levelBounds,
    ...
    render: function(){
      // the level *is* the scene (via our getRenderList method);
      renderer.render(this.getRenderList());
    },
